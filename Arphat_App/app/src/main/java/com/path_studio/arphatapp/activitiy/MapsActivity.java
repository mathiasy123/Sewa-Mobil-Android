...
/*
SUMBER BELAJAR LOCATION:
https://www.youtube.com/watch?v=ifoVBdtXsv0&t=2689s
*/
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private Button btnFind, btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MapsActivity.this, HalamanUtamaActivity.class);
                startActivity(i);
                finish();
            }
        });
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        startActivity(new Intent(MapsActivity.this, LocationResultActivity.class));
                        finish();
                    }
                }, 3000);
